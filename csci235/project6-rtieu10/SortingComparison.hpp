...
private:
     ...
     */
    int minPosition(int a[], int from, int to, int& comparisoncount);
     ...
     */
    void merge(int a[], int from, int mid, int to, int& comparisoncount);
    ...
    */
    int partition(int a[], int from, int to, int& comparisoncount2);
